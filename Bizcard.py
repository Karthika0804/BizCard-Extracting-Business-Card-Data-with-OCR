...
icon = Image.open("C:\\Users\\PRANESH\\Downloads\\Bizcard_Image.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By Karthika priyadhardhini",
                   page_icon= icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *Karthika priyadharshini *!"""})
...
#mydb = sql.connect(host="127.0.0.1",user="root",password="Aradhana@2509",database="Bizcard_Extract" )
#mycursor = mydb.cursor(buffered=True)
myconnection = pymysql.connect(host = "127.0.0.1",user = "root",passwd = "Aradhana@2509")
cur = myconnection.cursor()
cur.execute("create database IF NOT EXISTS Bizacard_Extraction")
myconnection = pymysql.connect(host = "127.0.0.1",user = "root",passwd = "Aradhana@2509",database = "Bizacard_Extraction")
cur = myconnection.cursor()
